...
/**
 * Clase que encapsula un tipo primitivo int en un objeto
 ...
 */
public class SimpleInteger extends Number{

  //No lo hacemos final para poder hacer cosas como value++
  public int value;

  public SimpleInteger(final int value){
    this.value = value;
  }

  public boolean equals(Object obj){
    if (obj instanceof SimpleInteger)
      return value == ((SimpleInteger) obj).value;
    return false;
  }
